...
Extrem große Kometen verwenden eine separate Seltenheitskarte. Ein Sektor darf nur dann einen solchen Körper erzeugen, wenn sein stabiler Seltenheitswert innerhalb von sechs Sektoren in jeder Richtung das lokale Maximum ist. Auch ihr Kandidaten-Seed ist von der normalen Felddichte getrennt. Dadurch verändern Dichteanpassungen weder Lage noch Aussehen der Riesen, und zwei Riesen können niemals direkt nebeneinander entstehen. Sie erreichen Radien von 1300 bis 1800 Welteinheiten und besitzen mindestens 845 Welteinheiten bebaubaren Radius.
